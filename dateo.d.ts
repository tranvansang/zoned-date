export default class Dateo extends Date {
	static defaultOffset: number

	constructor(options?: {offset?: number})
	constructor(dateo: Dateo, options?: {offset?: number})
	...
	withFullYear(year?: number | ((year: number) => number | undefined)): Dateo
	...
	withMonth(month?: number | ((month: number) => number | undefined)): Dateo
	...
	withDate(date?: number | ((date: number) => number | undefined)): Dateo
	...
	withHours(hours?: number | ((hours: number) => number | undefined)): Dateo
	...
	withMinutes(minutes?: number | ((minutes: number) => number | undefined)): Dateo
	...
	withSeconds(seconds?: number | ((seconds: number) => number | undefined)): Dateo
	...
	withMilliseconds(milliseconds?: number | ((milliseconds: number) => number | undefined)): Dateo
	...
	withTimezoneOffset(offset?: number | ((offset: number) => number | undefined)): Dateo
	...
	withTimezone(offset?: number | ((offset: number) => number | undefined)): Dateo
	...
	withTime(time?: number | ((time: number) => number | undefined)): Dateo
}
