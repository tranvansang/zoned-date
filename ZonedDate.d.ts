export default class ZonedDate {
	...
	constructor(offsetDate: ZonedDate, options?: {timezone?: string; disambiguation?: 'compatible' | 'earlier' | 'later' | 'reject'})
	...
	toDate(): Date
	toDateString: typeof Date.toDateString
	toISOString: typeof Date.toISOString
	toJSON: typeof Date.toJSON
	toLocaleDateString: typeof Date.toLocaleDateString
	toLocaleString: typeof Date.toLocaleString
	toLocaleTimeString: typeof Date.toLocaleTimeString
	toString: typeof Date.toString
	toTimeString: typeof Date.toTimeString
	toUTCString: typeof Date.toUTCString
	valueOf: typeof Date.valueOf
}
